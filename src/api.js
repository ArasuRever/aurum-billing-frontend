...
export const api = {
  ...
  getInventory: () => axios.get(`${API_URL}/inventory/list`), // Returns only AVAILABLE
  getVendorInventory: (id) => axios.get(`${API_URL}/inventory/vendor/${id}`), // Returns ALL (Available + Sold)
